...
public class LoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        UsernamePasswordAuthenticationToken authToken =
                new UsernamePasswordAuthenticationToken(memberId, password, null);
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        String username2 = customUserDetails.getUsername2();
        ...
        authRequest.setUsername2(username2);
        authRequest.setRole(String.valueOf(role));

        String token = jwtProvider.createAccessToken(authRequest);
